...
router.put('/:user_id/:character_name/equip', characterController.checkUserExistence, characterController.checkCharacterExistenceWithName, characterController.checkItemExistence, characterController.addingEquippedItemIntoInventory, characterController.removeInventoryitem, characterController.equipEquipment);
router.put('/:user_id/:character_name/unequip', characterController.simpleCheckForUnequipEquipment, characterController.checkUserExistence, characterController.checkCharacterExistence, characterController.simpleCheckForUnequipEquipment, characterController.checkCurrentItem, characterController.unequipEquipment);
