...
module.exports = {
    async createChallenge(req, res) {
        try {
            ...
            const challengeId = await challengeModel.createChallenge(challenge, creator_id, skillpoints);

            responseView.confirmCreated(res, { challenge_id: challengeId, challenge, creator_id, skillpoints }, 'Challenge created successfully');
        } catch (err){
    ...
    async updateChallenge(req, res) {
        ...
        if(differentCreator) {
            ...
            await challengeModel.updateChallenge(req.params.challenge_id, challenge, creator_id, skillpoints);
            responseView.sendSuccess(res, {id: req.params.challenge_id, challenge, creator_id, skillpoints}, 'Challenge updated successfully');
        } catch (err) {
    ...
    async completeChallenge(req, res) {
        try {
            ...
            if (req.body.creation_date == undefined) {
                responseView.BadRequest(res, 'Missing creation_date');
                return;
            }
            ...
            const completeId = await challengeModel.completeChallenge(challenge_id, user_id, completed, creation_date, notes);
            responseView.confirmCreated(res, {complete_id: completeId, challenge_id, user_id, completed, creation_date, notes}, 'Challenge attempted')
        } catch(err) {
